...
fun main() {
    var reportRepository = ReportRepositoryImpl(listOf())
    check(
        testcase = "There are no transactions in the given month",
        value = reportRepository.prepareMonthlySummary(LocalDateTime.parse("2025-04-03T10:15:30").month),
    ...
    check(
        ...
        value = reportRepository.prepareMonthlySummary(LocalDateTime.now().month),
